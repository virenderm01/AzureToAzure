...
<%@page import="com.servletfiles.UploadDetail"%>
		...
		<div class="panel">
			<h1>File Upload Status</h1>
			 <tr>
                  	 	...
                  	 	<td align="center">Thank you uploading the output file. Techdata team will be in touch with you shourtly</td>
						     <h1>Uploaded Files</h1>
            <table class="bordered_table">
               <thead>
                  <tr align="center"><th>File Name</th><th>File Size</th><th>File Type</th></tr>
               </thead>
               <tbody>
